...
python generate_model_to_pb.py --model ertsrgan --output_folder ../ffmpeg-tensorflow/dnn_models/x4/ --ckpt_path ./checkpoint/4X/270p_qp28/g_ertsrgan_4x/ --scale_factor 4

...
def d_percsr(filters=64,input_shape=(72,72,1)):
    ...
    model = tf.keras.Model(inputs=input, outputs=x,name='d_percsr')
    return model

def rad_percsr(discriminator=None,shape_hr=(72,72,1)):

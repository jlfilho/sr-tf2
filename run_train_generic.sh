...
# 1) First train quantitative oriented on generic dataset;  

# 2) Second train perceptual oriented on generic dataset;
...
--val_dataset_info_path datasets/loaded_harmonic/output/generic/test/4X/270p_qp17/dataset_info.txt \
--val_dataset_path datasets/loaded_harmonic/output/generic/test/4X/270p_qp17/dataset.tfrecords \
...
--hot_test_size 8 --batch_size 32 --learning_rate 1e-3 --type_reduce_lr schedules --schedule_values 100 200 \
